...
static const char *fonts[] 			= {
	"BlexMono Nerd Font:size=10:antialias=true:autohint=true",
    "Sarasa UI SC:size=10:antialias=true:autohint=true",
};
static const char dmenufont[] 		= "BlexMono Nerd Font:size=10:antialias=true:autohint=true";
...
static Key keys[] = {
	...
	{ MODKEY,						XK_a,	   spawn,		   SHCMD("maim -s | xclip -selection clipboard -t image/png") },
	{ MODKEY|ShiftMask,				XK_a,	   spawn,		   SHCMD("maim -sf jpg ~/Pictures/screenshots/maim_$(date +%s).jpg") },
	{ MODKEY,						XK_space,  spawn,		   SHCMD("j4-dmenu-desktop  --display-binary --dmenu=\"dmenu -i -p Launch: -l 15\"") },
	{ MODKEY|ControlMask|ShiftMask, XK_p,      spawn,		   SHCMD("dm-power") },
