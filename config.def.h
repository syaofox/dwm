...
static const int nativefullscreen = 0;  /* 1: send _NET_WM_STATE_FULLSCREEN to window (native fullscreen), 0: maximize without state (fake fullscreen) */
...
ResourcePref resources[] = {		
		{ "col_norm_fg",        STRING,  &col_norm_fg,        sizeof(col_norm_fg) },
		{ "col_norm_bg",        STRING,  &col_norm_bg,        sizeof(col_norm_bg) },
		{ "col_norm_border",    STRING,  &col_norm_border,    sizeof(col_norm_border) },
		{ "col_sel_fg",         STRING,  &col_sel_fg,         sizeof(col_sel_fg) },
		{ "col_sel_bg",         STRING,  &col_sel_bg,         sizeof(col_sel_bg) },
		{ "col_sel_border",     STRING,  &col_sel_border,     sizeof(col_sel_border) },
		{ "col_occ_fg",         STRING,  &col_occ_fg,         sizeof(col_occ_fg) },
		{ "col_occ_bg",         STRING,  &col_occ_bg,         sizeof(col_occ_bg) },
		{ "col_occ_border",     STRING,  &col_occ_border,     sizeof(col_occ_border) },
		{ "col_selocc_fg",      STRING,  &col_selocc_fg,      sizeof(col_selocc_fg) },
		{ "col_selocc_bg",      STRING,  &col_selocc_bg,      sizeof(col_selocc_bg) },
		{ "col_selocc_border",  STRING,  &col_selocc_border,  sizeof(col_selocc_border) },
		{ "col_status_fg",      STRING,  &col_status_fg,      sizeof(col_status_fg) },
		{ "col_status_bg",      STRING,  &col_status_bg,      sizeof(col_status_bg) },
		{ "col_status_border",  STRING,  &col_status_border,  sizeof(col_status_border) },
		{ "col_title_fg",       STRING,  &col_title_fg,       sizeof(col_title_fg) },
		{ "col_title_bg",       STRING,  &col_title_bg,       sizeof(col_title_bg) },
		{ "col_title_border",   STRING,  &col_title_border,   sizeof(col_title_border) },
		{ "col_titlesel_fg",    STRING,  &col_titlesel_fg,    sizeof(col_titlesel_fg) },
		{ "col_titlesel_bg",    STRING,  &col_titlesel_bg,    sizeof(col_titlesel_bg) },
		{ "col_titlesel_border",STRING,  &col_titlesel_border, sizeof(col_titlesel_border) },
		{ "col_tagunderline",   STRING,  &col_tagunderline,   sizeof(col_tagunderline) },
		{ "tagunderline",       INTEGER, &enabletagunderline, 0 },
		{ "tagicons",           INTEGER, &enabletagicons,     0 },
};
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_Tab,    cycleoccupiedtags,   {.i = +1 } },
